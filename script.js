...
const indexCertificatesData = {
    ...
    web: [
        { title: "Full Stack Web Development", org: "Amazon Web Services", date: "Completed", link: "https://coursera.org/share/5c660b3d71c1a0c841bd16cef1237295" }
    ]
};
...
const certTabColors = {
    ...
    web: 'from-blue-600 to-indigo-600'
};
                                            ...
                                            : cert.org === 'Google AR and VR - Coursera' || cert.org === 'Google'
                                                ...
                                                : cert.org === 'Microsoft - Coursera'
                                                    ...
                                                    : cert.org === 'Amazon Web Services'
                                                        ? '<img src="icons/Amazon_Web_Services_Logo.svg" alt="AWS Logo" class="w-full h-full object-contain">'
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (typingElement && typeof Typed !== 'undefined') {
        ...
        new Typed('.typing', {
            strings: ['Freelancer', 'Programmer', 'Junior IT Support'],
            typeSpeed: 80,
            backSpeed: 50,
            backDelay: 1500,
            startDelay: 500,
