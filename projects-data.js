...
const projectsData = {
    ...
    'wattwatch': {
        ...
        tagline: 'Smart Energy Consumption Tracker & Budget Manager',
        image: 'images/Projects/WattWatch_App/UI/7.DashboardScreen.jpg',
        shortDescription: 'A cross-platform mobile app (Android/iOS/Web) for monitoring household electricity consumption with real-time cost calculations, budget alerts, and appliance management.',
        detailedDescription: 'WattWatch is a cross-platform mobile application built with Expo SDK 57 and React Native 0.86 that helps users monitor and manage their household electricity consumption. The app connects to a Supabase backend for authentication, real-time data storage, and push notifications. Features include a dashboard showing monthly kWh consumption and estimated costs calculated from current Meralco rates, appliance management with CRUD operations, energy analytics with historical charts, budget alerts with local and push notifications, in-app notification center, and an admin panel for rate management.',
        features: [
            {
                icon: 'fas fa-tachometer-alt',
                title: 'Energy Dashboard',
                description: 'Real-time monthly kWh consumption, estimated cost from live Meralco rates, and top energy-consuming appliances'
            },
            {
                icon: 'fas fa-plug',
                title: 'Appliance Management',
                description: 'Add, edit, remove appliances with wattage and daily usage hours; toggle active/inactive states'
            },
            {
                icon: 'fas fa-chart-bar',
                title: 'Energy Analytics',
                description: 'Historical consumption charts and breakdowns over time with detailed energy usage trends'
            },
            {
                icon: 'fas fa-bell',
                title: 'Budget Alerts',
                description: 'Set monthly budget and alert thresholds; receive local and push notifications when approaching limits'
            },
            {
                icon: 'fas fa-envelope',
                title: 'In-App Notifications',
                description: 'Notification inbox with read/unread tracking and clear-all functionality synced with Supabase'
            },
            {
                icon: 'fas fa-user-shield',
                title: 'Authentication & Admin Panel',
                description: 'Full auth flow (signup, login, password reset, email verification) plus admin panel for rate management'
            }
        ],
        techStack: [
            { name: 'Expo SDK 57', icon: 'fas fa-bolt', color: 'text-blue-400' },
            { name: 'React Native 0.86', icon: 'fab fa-react', color: 'text-blue-400' },
            { name: 'NativeWind', icon: 'fas fa-palette', color: 'text-teal-500' },
            { name: 'Expo Router', icon: 'fas fa-route', color: 'text-purple-500' },
            { name: 'TypeScript', icon: 'fas fa-code', color: 'text-blue-600' },
            { name: 'Zustand', icon: 'fas fa-store', color: 'text-orange-500' },
            { name: 'TanStack Query', icon: 'fas fa-server', color: 'text-red-500' },
            { name: 'Supabase', icon: 'fas fa-database', color: 'text-green-600' },
            { name: 'React Hook Form', icon: 'fas fa-wpforms', color: 'text-indigo-500' },
            { name: 'Zod', icon: 'fas fa-check-circle', color: 'text-green-500' },
            { name: 'EAS Build', icon: 'fas fa-cube', color: 'text-purple-600' }
        ],
        links: {
            live: null,
            github: null,
        ...
        imageViewerConfig: {
            userTypes: [
                { id: 'screens', name: 'App Screens', count: 17 }
            ],
            basePath: 'images/Projects/WattWatch_App/UI/',
            images: [
                '1.SignIn.jpg',
                '2.Registration.jpg',
                '3.ForgotPassword.jpg',
                '4.ResetPasswordScreen.jpg',
                '5.AboutWattWatch.jpg',
                '6.BudgetAlertNotification.jpg',
                '7.DashboardScreen.jpg',
                '8.EnergyTips.jpg',
                '9.NotificationScreen.jpg',
                '10.AppliancesScreen.jpg',
                '11.SelectAppliancesScreen.jpg',
                '12.AddAppliancesScreen.jpg',
                '13.AnalyticsScreen.jpg',
                '14.AnalyticsScreen (2).jpg',
                '15.AnalyticsScreen (3).jpg',
                '16.ProfileScreen.jpg',
                '17.AdminPanelScreen.jpg'
            ]
        }
    },
    'portfolio-template': {
